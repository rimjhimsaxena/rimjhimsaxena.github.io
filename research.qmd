...
<span class="paper-title-link">Barriers within Borders: Climate Change, Market Barriers, and Structural Transformation</span> <span class="paper-status draft">DRAFT ON REQUEST</span>
...
<span class="paper-title-link">[Stumped by the Sun, Saved by the Side: How Do Teams Adapt to Heat? Evidence on Peer Adaptation](/pdfs/SBS_cricket_march26.pdf)</span> <span class="paper-status">SUBMITTED</span>
